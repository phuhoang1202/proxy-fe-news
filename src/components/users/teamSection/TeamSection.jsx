        ...
        <div className='-mx-4 flex flex-wrap justify-center'>
          ...
          <div className='w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4'>
            <div className='group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none'>
              ...
              <div className='text-center'>
                <h4 className='mb-1 text-lg font-semibold text-dark dark:text-white'>Stuard Ferrel</h4>
                <p className='mb-5 text-sm text-body-color dark:text-dark-6'>Digital Marketer</p>
                <div className='flex items-center justify-center gap-5'>
                  <a href='javascript:void(0)' className='text-dark-6 hover:text-primary'>
                    <svg
                      width={18}
          ...
          <div className='w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4'>
            <div className='group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none'>
              ...
              <div className='text-center'>
                <h4 className='mb-1 text-lg font-semibold text-dark dark:text-white'>Eva Hudson</h4>
                <p className='mb-5 text-sm text-body-color dark:text-dark-6'>Creative Designer</p>
                <div className='flex items-center justify-center gap-5'>
                  <a href='javascript:void(0)' className='text-dark-6 hover:text-primary'>
                    <svg
                      width={18}
          ...
          <div className='w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4'>
            <div className='group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none'>
              ...
              <div className='text-center'>
                <h4 className='mb-1 text-lg font-semibold text-dark dark:text-white'>Jackie Sanders</h4>
                <p className='mb-5 text-sm text-body-color dark:text-dark-6'>SEO Expert</p>
                <div className='flex items-center justify-center gap-5'>
                  <a href='javascript:void(0)' className='text-dark-6 hover:text-primary'>
                    <svg
                      width={18}
