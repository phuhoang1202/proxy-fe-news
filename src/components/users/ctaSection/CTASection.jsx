...
export default function CTASection() {
  return (
    <section className='relative z-10 overflow-hidden bg-compo2 py-20 lg:py-[115px]'>
          ...
          <div className='-mx-4 flex flex-wrap items-stretch'>
            <div className='w-full px-4'>
              <div className='mx-auto text-center'>
                <h2 className='mb-2.5 text-biggerName font-bold text-white md:text-[38px] md:leading-[1.44]'>
                  <span>Bạn đang tìm kiếm điều gì?</span> <br />
                  <span className='text-biggerName font-normal md:text-[40px] ml-2'>Bắt đầu ngay bây giờ</span>
                </h2>
                ...
                <button className=' gap-4 rounded-md bg-white/[0.12] h-14 w-60 px-6 py-[10px] text-base font-medium text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark uppercase'>
                  Liên hệ CSKH
                </button>
              </div>
            </div>
